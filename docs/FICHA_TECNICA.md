...
2. **Buscador Local (RAM Index):** Evita latencias de base de datos al mantener el catálogo de productos indexado en memoria, permitiendo búsquedas _fuzzy_ (tolerantes a errores ortográficos).
...
- **Optimización de Costos:** Uso de Haiku 4.5 para maximizar la velocidad y minimizar el costo por mensaje, manteniendo capacidades de _Function Calling_ superiores.
