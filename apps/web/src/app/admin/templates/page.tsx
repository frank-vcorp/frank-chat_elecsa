...
export default function TemplatesPage() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setTemplates((prev) => [
        ...prev,
        { id: docRef.id, title: newTitle.trim(), content: newContent.trim() },
      ]);
      setNewTitle("");
      setNewContent("");
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-4 mb-6 border border-gray-200">
          ...
          <button
            ...
            aria-label={
              editingId ? "Actualizar plantilla" : "Crear nueva plantilla"
            }
          >
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200">
          <h2 className="text-lg font-medium p-4 border-b border-gray-200 text-gray-800">
